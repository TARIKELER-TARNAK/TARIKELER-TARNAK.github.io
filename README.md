...
## 🌐 Canlı: [tarikeler.github.io](https://tarikeler.github.io)
...
- Saf HTML + CSS + JavaScript (framework yok, derleme gerekmez)
- Karanlık tema, tamamen responsive

## 🚀 Yerel Çalıştırma

```bash
# 1) Repoyu kopyala
git clone https://github.com/TARIKTR1099/tarikeler.github.io.git
